...
const FloatingCallButton = () => {
    return (
        <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3">
            <a
                href="tel:3238801224"
                className="group relative flex items-center justify-center w-16 h-16 bg-red-600 text-white rounded-2xl shadow-2xl hover:bg-red-700 transition-all duration-300 hover:scale-110 active:scale-95"
                aria-label="Call Wapakoneta Bed Bug Pros"
            >
                <div className="absolute inset-0 bg-red-600 rounded-2xl animate-ping opacity-20 group-hover:hidden" />
            ...
            <div className="flex items-center gap-2 bg-white/90 backdrop-blur-sm px-4 py-1.5 rounded-full border border-slate-200 shadow-sm animate-pulse">
                ...
                <span className="text-[10px] font-bold text-slate-600 uppercase tracking-tighter">Emergency Techs - Wapakoneta</span>
            </div>
